...
export class AddExpenseComponent implements OnInit {
  ...
  constructor(private _expenseService:ExpenseService, private _router:Router, private _activatedRouter:ActivatedRoute) { }

  ngOnInit(): void {

    const isIdPresent=this._activatedRouter.snapshot.paramMap.has('id');
    if(isIdPresent){
